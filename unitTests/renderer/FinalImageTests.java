...
/**
 * Test rendering for the presentation
 */
public class FinalImageTests {
    ...
    /**
     * Set the scene for the presentation picture
     *
     * @param scene1
     */
    private void setBackgammonSceneGeometry(Scene scene1) {
        ...
        BuildTriangles(scene1, material);//build the triangles
        ...
        addGlassAndCubes(scene1);//add the glass and the white cubes
        ...
        scene1.getGeometries().add(
                new Cylinder(
                        new Ray(
                                new Point(-7.5, -110, 10),
                                new Vector(0, 1, 0)),
                        1, 220).setMaterial(material)
                        .setEmission(new Color(228, 218, 199).reduce(2))//center cylinder
        );
        scene1.getGeometries().add(
                new Polygon(
                        new Point(-85, -110, 0),
    ...
    private static void setSceneBackgammonLight(Scene scene1) {
        scene1.getLights().add(
                new SpotLight(new Color(900, 500, 500),
                        new Point(-92.5, 195, -35),
                        new Vector(1, -1, 1)).setKl(0.001).setKq(0.0001));
    ...
    /**
     * add the cubes and the glass to the scene
     *
     * @param scene1
     */
    private static void addGlassAndCubes(Scene scene1) {
        ...
        scene1.getGeometries().add(
                new Cylinder(
                        new Ray(
                                new Point(-7.5, 110, 60),
                                new Vector(0, 0, 1)), 4, 400)
        ...
        for (double i = -2 * Math.PI; i <= 0; i += 0.05) {
            scene1.getGeometries().add(
                    new Cylinder(
                            new Ray(
                                    place.add(
                                            new Vector(i - 0.5, -Math.sin(i), 10)),
                                    new Vector(0, 0, 1)), 0.4, 0.5)
...
//*********************TEST_02__DNA***************************//
    /**
     * Test for a picture of a DNA (Molecule)
     */
    @Test
    ...
    //*********************TEST_03__Polygons and spheres***************************//
    /**
     * test for the first picture of the presentation
     */
    @Test
    ...
    /**
     * set the scene with the polygon
     * @return
     */
    private static Scene setPolygonScene() {
        ...
        Material material = new Material()
                ...
                .setShininess(301), material1 = new Material()
                .setKd(0.2)
                .setKs(1)
                .setKr(0.4)
                .setShininess(300);
